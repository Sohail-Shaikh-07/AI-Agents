...
class DataProcessor:
    ...
    def process_and_save(self, json_data, output_filename=None):
        ...
        for record in json_data:
            ...
            # row["NumberOfPoints"] = record.get("NumberOfPoints") # DROPPED
            ...
            # Extract YearCreated directly & Validate
            ...
            # DROPPED
            # row["DateCreated"]
            # row["DateLastVerified"]
            # row["DateLastStatusUpdate"]
            # row["DataQualityLevel"]
